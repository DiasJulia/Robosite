...
import member9 from 'member9.png';
import member10 from 'member10.png';
import member11 from 'member11.png';
import member12 from 'member12.png';

export { member1, member2, member3, member4, member5, member6, member7, member8, member9, member10, member11, member12 };