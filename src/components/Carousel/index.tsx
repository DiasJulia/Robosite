...
const Carousel: React.FC = () => {
  const [slides, setSlides] = useState<string[]>([SlidePic1, SlidePic2, SlidePic3]);
  ...
  return (
    <Container>
        <Content>
            <Arrow src={Arrow1} alt="Seta para a esquerda" onClick={() => moveSlide(false)} />
            <div>
              <h3>{description[slideState]}</h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
            <Arrow src={Arrow2} alt="Seta para a direita" onClick={() => moveSlide(true)} />
        </Content>
        <SliderStyled>
