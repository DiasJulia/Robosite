  ...
  return (
    <Container>
        ...
        <br />
            <Row>
                <CategoriaContainer>
                    <img src={Arrow3} alt="Seta" /> <h2>Small Size League</h2> <h3>RoboCup | LARC</h3>
                ...
                <CategoriaImg BackgroundImg={CategoriaSSL}></CategoriaImg>
            </Row>
            <Details>
        ...
        <br />
            <Row>
                <CategoriaContainer>
                    <img src={Arrow3} alt="Seta" /> <h2>VERY Small Size League</h2> <h3> LARC | IronCup</h3>
                ...
                <CategoriaImg BackgroundImg={CategoriaVSS}></CategoriaImg>
            </Row>
            <Row>
                <CategoriaContainer>
                    <img src={Arrow3} alt="Seta" /> <h4>Abordagem com Deep Learning</h4>
                ...
                <CategoriaContainer width="45%">
                    <img src={Arrow3} alt="Seta" /> <h4>Abordagem Determinística</h4>
        ...
        <br />
            <Row>
                <CategoriaContainer>
                    <img src={Arrow3} alt="Seta" /> <h2>Simulação 2d</h2> <h3>RoboCup | LARC | IronCup</h3>
                ...
                <CategoriaImg BackgroundImg={Categoria2D}></CategoriaImg>
            </Row>
            <Details>
